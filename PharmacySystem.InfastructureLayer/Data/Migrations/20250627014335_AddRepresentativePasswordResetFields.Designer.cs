...
namespace PharmacySystem.InfastructureLayer.Data.Migrations
{
    ...
    [Migration("20250627014335_AddRepresentativePasswordResetFields")]
    partial class AddRepresentativePasswordResetFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PharmacySystem.DomainLayer.Entities.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PharmacySystem.DomainLayer.Entities.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PharmacySystem.DomainLayer.Entities.CartWarehouse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PharmacySystem.DomainLayer.Entities.CartItem", b =>
                {
                    b.HasOne("PharmacySystem.DomainLayer.Entities.CartWarehouse", "CartWarehouse")
                        .WithMany("CartItems")
                        .HasForeignKey("CartWarehouseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PharmacySystem.DomainLayer.Entities.CartWarehouse", b =>
                {
                    b.HasOne("PharmacySystem.DomainLayer.Entities.Cart", "Cart")
                        .WithMany("CartWarehouses")
